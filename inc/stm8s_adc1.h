...
//Включить ADC1
#define ADC1_Enable ADC1->CR1 |= ADC1_CR1_ADON;
//Выключить ADC1
#define ADC1_Disable ADC1->CR1 &= (uint8_t)(~ADC1_CR1_ADON);

#define ADC1_ScanMode_Enable ADC1->CR2 |= ADC1_CR2_SCAN;
#define ADC1_ScanMode_Disable ADC1->CR2 &= (uint8_t)(~ADC1_CR2_SCAN);

#define ADC1_DataBuffer_Enable ADC1->CR3 |= ADC1_CR3_DBUF;
#define ADC1_DataBuffer_Disable ADC1->CR3 &= (uint8_t)(~ADC1_CR3_DBUF);
/**
  * @brief  Start ADC1 conversion
  */
#define ADC1_StartConversion ADC1->CR1 |= ADC1_CR1_ADON;
